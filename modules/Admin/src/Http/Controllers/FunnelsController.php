...
class FunnelsController extends Controller {
    ...
    public function __construct(Contact $contact) { 
        ...
        View::share('sub_page_title', 'Funnels');
        View::share('helper',new Helper);
        View::share('heading','Funnels');
        View::share('route_url',route('funnels')); 
    ...
    { 
        $page_title = 'Funnels';
        $sub_page_title = 'View Funnels';
        $page_action = 'View Funnels'; 
        ...
        return view('packages::funnels.index', compact('result_set','programs','data', 'page_title', 'page_action','sub_page_title'));
    }
