...
class ConsumerController extends Controller {
    ...
    public function __construct(Contact $contact) { 
        ...
        View::share('viewPage', 'Consumer');
        View::share('sub_page_title', 'Consumer');
        View::share('helper',new Helper);
        View::share('heading','Consumer');
        View::share('route_url',route('consumer')); 
    ...
    { 
        $page_title = 'Consumer';
        $sub_page_title = 'View Consumer';
        $page_action = 'View Consumer'; 
        ...
        return view('packages::consumer.index', compact('result_set','programs','data', 'page_title', 'page_action','sub_page_title'));
    }
