                            ...
                            <div class="portlet light portlet-fit bordered">
                                    ...
                                    <div class="caption">
                                     ...
                                     <div class="col-md-3 pull-right">
                                            <div style="width: 150px;" class="input-group"> 
                                                <a href="<?php echo e(route('businessNature.create')); ?>">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <form action="<?php echo e(route('businessNature')); ?>" method="get" id="filter_data">
                                         ...
                                         <div class="col-md-2">
                                             <a href="<?php echo e(route('businessNature')); ?>">   <input type="submit" value="Reset" class="btn btn-default form-control"> </a>
                                        </div>
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="contact">
                                        ...
                                        <tbody>
                                        <?php foreach($businessNature as $key => $result): ?>
                                            <tr>
                                             <th>  <?php echo e(++$key); ?> </th>
                                                <td> <?php echo e($result->title); ?> </td> 
                                                    ...
                                                    <td> 
                                                        <a href="<?php echo e(route('businessNature.edit',$result->id)); ?>">
                                                            <i class="fa fa-edit" title="edit"></i> 
                                                        </a>

                                                        <?php echo Form::open(array('class' => 'form-inline pull-left deletion-form', 'method' => 'DELETE',  'id'=>'deleteForm_'.$result->id, 'route' => array('businessNature.destroy', $result->id))); ?>
                                    ...
                                    <span>
                                     ...
                                     <div class="center" align="center">  <?php echo $businessNature->appends(['search' => isset($_GET['search'])?$_GET['search']:''])->render(); ?></div>
                                </div>
                            </div>
