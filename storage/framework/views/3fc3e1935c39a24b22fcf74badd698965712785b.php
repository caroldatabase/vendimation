                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                ...
                                <div class="portlet-body">
                                  ...
                                  <?php echo Form::model($category, ['route' => ['contact.store'],'class'=>'form-horizontal contact-form','id'=>'contact-form','enctype'=>'multipart/form-data']); ?>

                                  
                                  <?php echo $__env->make('packages::contact.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
