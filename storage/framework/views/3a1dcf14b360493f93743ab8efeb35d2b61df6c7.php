                        ...
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                ...
                                <div class="portlet-body">
                                  ...
                                  <?php echo Form::model($businessNature, ['route' => ['businessNature.store'],'class'=>'form-horizontal user-form','id'=>'user-form','enctype'=>'multipart/form-data']); ?>

                                  
                                  <?php echo $__env->make('packages::businessNature.form', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
