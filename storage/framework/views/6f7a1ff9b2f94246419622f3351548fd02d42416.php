                            ...
                            <div class="portlet light portlet-fit bordered">
                                ...
                                <div class="portlet-body">
                                    <div class="table-toolbar">
                                        <div class="row">
                                            <form action="<?php echo e(route('category')); ?>" method="get" id="filter_data">
                                    ...
                                    <table class="table table-striped table-hover table-bordered" id="">
                                        ...
                                        <?php foreach($categories as $key => $result): ?>
                                            <tr>
                                                ...
                                                <td>
                                                <a href="<?php echo e(url::asset('storage/uploads/category/'.$result->category_group_image)); ?>" target="_blank" >
                                                <img src="<?php echo e(url::asset('storage/uploads/category/'.$result->category_group_image)); ?>" width="100px" height="50px;"> </a>  </td>
                                                    ...
                                                    <td> 
                                                        <a href="<?php echo e(route('category.edit',$result->id)); ?>">
