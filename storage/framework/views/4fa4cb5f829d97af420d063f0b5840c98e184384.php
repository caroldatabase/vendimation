...
<div class="page-container">
 ...
 -->
                        <li class="nav-item start active <?php echo e((isset($page_title) && $page_title=='Target Market')?'open':''); ?>">
                                <a href="javascript:;" class="nav-link nav-toggle">
                                    <i class="glyphicon glyphicon-th"></i>
                                    <span class="title">Target Market</span>
                                    <span class="arrow <?php echo e((isset($page_title) && $page_title=='Target Market')?'open':''); ?>"></span>
                                </a>
                                <ul class="sub-menu" style="display: <?php echo e((isset($page_title) && $page_title=='Target Market')?'block':'none'); ?>">
                                    <li class="nav-item  <?php echo e((isset($page_title) && $page_action=='View Target Market')?'active':''); ?>">
                                        <a href="<?php echo e(route('targetMarket')); ?>" class="nav-link ">
                                           <i class="glyphicon glyphicon-eye-open"></i> 
                                            <span class="title">
                                                View Target Market 
                                            </span>
                                    ...
                                    <li class="nav-item  <?php echo e((isset($page_title) && $page_action=='Create Target Market')?'active':''); ?>">
                                        <a href="<?php echo e(route('targetMarket.create')); ?>" class="nav-link ">
                                           <i class="glyphicon glyphicon-plus-sign"></i> 
                                            <span class="title">
                                               Add Target Market
                                            </span>
                        ...
                        <li class="nav-item start active <?php echo e((isset($page_title) && $page_title=='Business Nature')?'open':''); ?>">
                            <a href="javascript:;" class="nav-link nav-toggle">
                                <i class="glyphicon glyphicon-th"></i>
                                <span class="title">Business Nature</span>
                                <span class="arrow <?php echo e((isset($page_title) && $page_title=='Business Nature')?'open':''); ?>"></span>
                            </a>
                            <ul class="sub-menu" style="display: <?php echo e((isset($page_title) && $page_title=='Business Nature')?'block':'none'); ?>">
                                <li class="nav-item  <?php echo e((isset($page_title) && $page_action=='View Business Nature')?'active':''); ?>">
                                    <a href="<?php echo e(route('businessNature')); ?>" class="nav-link ">
                                       <i class="glyphicon glyphicon-eye-open"></i> 
                                        <span class="title">
                                            View Target Market 
                                        </span>
                                ...
                                <li class="nav-item  <?php echo e((isset($page_title) && $page_action=='Create Business Nature')?'active':''); ?>">
                                    <a href="<?php echo e(route('businessNature.create')); ?>" class="nav-link ">
                                       <i class="glyphicon glyphicon-plus-sign"></i> 
                                        <span class="title">
                                           Add Business Nature
                                        </span>
