                      ...
                      <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="portlet light portlet-fit portlet-form bordered">
                                ...
                                <?php echo Form::model($businessNature, ['method' => 'PATCH', 'route' => ['businessNature.update', $businessNature->id],'class'=>'form-horizontal user-form','id'=>'form_sample_3','enctype'=>'multipart/form-data']); ?>

                                    <?php echo $__env->make('packages::businessNature.form', compact('businessNature'), array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
                                <?php echo Form::close(); ?> 
                                    <!-- END FORM-->
                                </div>
